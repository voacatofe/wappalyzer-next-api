...
# Carregar o arquivo technologies.json local
try:
...
def index():
    ...
    <body>
        ...
        <p>Esta API detecta tecnologias em websites, com foco especial em tecnologias de frontend e ferramentas de chat/atendimento ao cliente.</p>
